...
parser.add_argument('--restore-file', type=str, default='drive/My Drive/DL_Project/vae_model_folder/best.pt',
...
if restore_vae_file is not None:
    restore_vae_path = os.path.join('drive/My Drive/DL_Project/models_vae_1', restore_vae_file)
...
if __name__ == "__main__":
    ...
    restore_path = args.restore_file  # specify checkpoint to restore from or specify None
